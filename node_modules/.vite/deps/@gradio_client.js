...
var Ve = "sleeptime";
var Ye = "heartbeat";
var Qe = "component_server";
var Xe = "reset";
var et = "cancel";
var tt = "app_id";
var Oe = "This application is currently busy. Please try again. ";
var M = "Connection errored out. ";
var N = "Could not resolve app config. ";
var st = "Could not get space status. ";
var nt = "Could not get API info. ";
var ce = "Space metadata could not be loaded. ";
var ot = "Invalid URL. A full URL path is required.";
var it = "Not authorized to access this space. ";
var Te = "Invalid credentials. Could not login. ";
var rt = "Login credentials are required to access this space.";
var at = "File system access is only available in Node.js environments";
var Ae = "Root URL not found in client config";
var ct = "Error uploading file";
  ...
  return Object.keys(e).forEach((i) => {
    (i === "named_endpoints" || i === "unnamed_endpoints") && (n[i] = {}, Object.entries(e[i]).forEach(
      ([o, { parameters: r, returns: a }]) => {
        ...
        )?.id || t[o.replace("/", "")] || -1, l = u !== -1 ? s.dependencies.find((c) => c.id == u)?.types : { generator: false, cancel: false };
...
async function ae(e, s = void 0, t = [], n = false, i = void 0) {
  if (Array.isArray(e)) {
    let o = [];
    return await Promise.all(
      e.map(async (r, a) => {
...
async function At(e, s, t) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      ...
      r = (await import("./__vite-browser-external-DYxpcVy9-TYBWYDTX.js")).resolve(process.cwd(), n.meta.path), o = await p.readFile(r);
    } else
      throw new Error(at);
    const a = new Blob([o], {
...
async function Ct(e, s = {}) {
  ...
  return new Promise(async (i, o) => {
    const r = this.submit(e, s, null, null, true);
    let a;
    for await (const u of r)
      u.type === "data" && (n && i(a), t = true, a = u), u.type === "status" && (u.stage === "error" && o(u), u.stage === "complete" && (n = true, t && i(a)));
  });
}
...
var Nt = /^(?=[^]*\b[dD]iscussions{0,1}\b)(?=[^]*\b[dD]isabled\b)[^]*$/;
async function Se(e) {
  try {
    const s = await fetch(
...
var It = class extends TransformStream {
  #e = "";
...
function Ut(e) {
  let s = new TextDecoderStream(), t = new It({ allowCR: true });
...
function Wt(e, s = {}, t, n, i) {
  try {
    ...
    let H, b = null, T = false, de = {}, z = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
            ...
            let me = async function(oe) {
              try {
                ...
                console.error("Unexpected client exception", E), o({
                  ...
                  fn_index: d,
                  time: /* @__PURE__ */ new Date()
                }), ["sse_v2", "sse_v2.1", "sse_v3"].includes(O) && (pe(P, je.abort_controller), P.open = false, r());
              }
            };
    ...
    const ne = [], B = [], _e = {
      ...
      next: p,
      throw: async (f) => (u(f), p()),
      return: async () => (r(), { value: void 0, done: true }),
      cancel: qe,
      send_chunk: (f) => {
...
var V = class {
  ...
  close() {
    this.closed = true, pe(this.stream_status, this.abort_controller);
  }
